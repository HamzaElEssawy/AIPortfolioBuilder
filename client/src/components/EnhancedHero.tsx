      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button 
                ...
                onClick={() => scrollToSection("featured-case-studies")}
              >
          ...
          <div className="relative">
            ...
            <div className="absolute top-10 -left-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 animate-float">
            ...
            <div className="absolute bottom-16 -right-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 animate-float-delayed">
              <div className="flex items-center gap-2">
            ...
            <div className="absolute top-1/2 -right-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 animate-float">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center">
                  <Award className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                </div>
                <div>
                  <div className="font-semibold text-sm text-gray-900 dark:text-white">70%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-300">Automation Rate</div>
                </div>
              </div>
            </div>
          </div>
